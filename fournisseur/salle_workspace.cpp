...
void salle_workspace::on_add_clicked()
{
    ui->C->setCurrentIndex(1);
}

void salle_workspace::on_update_clicked()
{
    ui->C->setCurrentIndex(2);
}

void salle_workspace::on_delete_2_clicked()
{
    ui->C->setCurrentIndex(3);
}

void salle_workspace::on_consult_clicked()
{
    ui->C->setCurrentIndex(4);
}

void salle_workspace::on_delete_4_clicked()
{
    ui->C->setCurrentIndex(6);
}

void salle_workspace::on_stat_clicked()
{
    ui->C->setCurrentIndex(5);
}

void salle_workspace::on_home_clicked()
{
    ui->C->setCurrentIndex(0);
}

void salle_workspace::on_home_2_clicked()
{
    ui->C->setCurrentIndex(0);
}

void salle_workspace::on_home_3_clicked()
{
    ui->C->setCurrentIndex(0);
}

void salle_workspace::on_home_4_clicked()
{
    ui->C->setCurrentIndex(0);
}

void salle_workspace::on_home_5_clicked()
{
    ui->C->setCurrentIndex(0);
}

void salle_workspace::on_home_6_clicked()
{
    ui->C->setCurrentIndex(0);
}
