...
arduino_salle::arduino_salle()
{

}

int arduino_salle::connect_arduino()
{
...
int arduino_salle::close_arduino()
{
    if(serial->isOpen())
    {
        serial->close();
...
QByteArray arduino_salle::read_from_arduino()
{
...
int arduino_salle::write_to_arduino( QByteArray d)
