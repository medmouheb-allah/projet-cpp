...
*/
    ...
    show_table();
     QLabel label;
     QMovie *supe = new QMovie("C:/Users/user/Desktop/tttt/hi.gif");
     QMovie *feu2 = new QMovie("C:/Users/user/Desktop/tttt/feuu.gif");

       ui->supe->setMovie(supe);
       ui->feu2->setMovie(feu2);
       supe->start();
       feu2->start();
...
void event_workspace::on_pushButton_2_clicked()
{
    ...
    QString strStream;
            ...
            out <<  "<html>\n"
                ...
                "<center><h1 style='color:#732626;'>Liste des événements</h1></br></br><table border=1 cellspacing=0 cellpadding=2 color=#732626>\n";
...
void event_workspace::on_map_clicked()
{
