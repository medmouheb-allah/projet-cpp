    ...
    ui(new Ui::client_workspace)
{
  ...
  QObject::connect(a.getserial(),SIGNAL(readyRead()),this,SLOT(update_label()));// yestana fi ma3louma mel arduino
    ...
    ui->update->setModel(c.afficher());
    ui->suppe->setModel(c.afficher());
        ...
        connect(mMediaPlayer,&QMediaPlayer::positionChanged,[&](qint64 pos)
               {
                ...
                QLabel label;
                    QMovie *vol = new QMovie("C:/Users/user/Desktop/tttt/200w.gif");
                    QMovie *gif_don = new QMovie("C:/Users/user/Desktop/tttt/id.gif");
                     QMovie *labelh = new QMovie("C:/Users/user/Desktop/tttt/oo.gif");
                     QMovie *fle = new QMovie("C:/Users/user/Desktop/tttt/fle.gif");
                     QMovie *sp = new QMovie("C:/Users/user/Desktop/tttt/hi.gif");
                     QMovie *bg = new QMovie("C:/Users/user/Desktop/tttt/fl.gif");

                     QMovie *hist = new QMovie("C:/Users/user/Desktop/tttt/bo.gif");
                     QMovie *hor = new QMovie("C:/Users/user/Desktop/tttt/kh.gif");
                      QMovie *mm = new QMovie("C:/Users/user/Desktop/tttt/oo.gif");
                      QMovie *lo = new QMovie("C:/Users/user/Desktop/tttt/po.gif");
                      QMovie *feu = new QMovie("C:/Users/user/Desktop/tttt/feuu.gif");

                    ui->vol->setMovie(vol);
                    ui->labelh->setMovie(labelh);
                    ui->gif_don->setMovie(gif_don);
                    ui->fle->setMovie(fle);
                     ui->sp->setMovie(sp);
                     ui->bg->setMovie(bg);
                     ui->hist->setMovie(hist);
                       ui->hor->setMovie(hor);
                       ui->mm->setMovie(mm);
                       ui->lo->setMovie(lo);
                        ui->feu->setMovie(feu);
...
ui->ouvrirS->setEnabled(true);
ui->ajouter_client->setCurrentIndex(6);
...
void client_workspace::on_excelll_clicked()
{
    QString fileName = QFileDialog::getSaveFileName(this, tr("Excel file"), qApp->applicationDirPath (),
        ...
        obj.addField(4, "desription", "char(90)");
        obj.addField(5, "nom_ev", "char(90)");
...
{
    Smtp* smtp = new Smtp("dhouha.ghariani@esprit.tn","14fev2001", "smtp.gmail.com");
        //connect(smtp, SIGNAL(status(QString)), this, SLOT(mailSent(QString)));

            smtp->sendMail("dhouha.ghariani@esprit.tn", "dhouha.ghariani@esprit.tn" , ui->msg->text()," ");
}
...
void client_workspace::on_updateee_clicked()
{
    ui->ajouter_client->setCurrentIndex(2);
}

void client_workspace::on_pushButton_7_clicked()
{
 ui->ajouter_client->setCurrentIndex(2);
}
...
void client_workspace::on_ouvrirS_clicked()
{
    c.incrParking();
               data2.clear();
               data2.append("5");
                a.write_to_arduino(data2);
                  ui->ouvrirS->setDisabled(true);
ui->lcdNumber1->display(c.count());
}


void client_workspace::on_ouvrir_2E_clicked()
{
    c.decrParking();
    data2.clear();
    data2.append("6");
     a.write_to_arduino(data2);
     ui->ouvrir_2E->setDisabled(true);
     ui->lcdNumber1->display(c.count());
