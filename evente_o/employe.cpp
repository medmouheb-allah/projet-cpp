...
employe::employe(int d,QString a,QString b,QString c,int e,QString f, QString r)
{
  nom=b ;
  prenom=c ;
  email=a ;
...
bool employe :: ajouter()
{
    ...
    query.prepare("insert into EMPLOYE (ID_EMP,MAIL,NOM_EMP,PRENOM_EMP,TEL,GENRE,role) values(:id,:email,:nom,:prenom,:num,:genre,:role)") ;
...
bool employe::modifier(int id,QString email,QString nom,QString prenom,int num, QString genre, QString role)
 {
     ...
     query.prepare("UPDATE EMPLOYE set ID_EMP=:id,MAIL=:email,NOM_EMP=:nom,PRENOM_EMP=:prenom,TEL=:num,GENRE=:genre,ROLE=:role where ID_EMP=:id");
