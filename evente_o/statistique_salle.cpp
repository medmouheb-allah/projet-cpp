...
statistique_salle::statistique_salle(QDialog *parent) :
    QDialog(parent),
    ui(new Ui::statistique_salle)
{
    ui->setupUi(this);
}

statistique_salle::~statistique_salle()
{
    delete ui;
}


int statistique_salle::Stat_partie1()
{
    QSqlQuery query;
    int count=0 ;
...
int statistique_salle::Stat_partie2()
{
    QSqlQuery query;
    int count=0 ;
...
int statistique_salle::Stat_partie3()
{
    QSqlQuery query;
    int count=0 ;
...
void statistique_salle::paintEvent(QPaintEvent *)
{
