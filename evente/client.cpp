...
bool Client::ajouter()
{
 ...
 QSqlQueryModel*Client:: aff()
 {
     ...
     model->setQuery("SELECT client_.id_client,client_.nom,client_.prenom,client_.adr_email,evenement.description,evenement.nom,evenement.date_ev FROM CLIENT_ INNER JOIN EVENEMENT ON CLIENT_.ID_CLIENT=EVENEMENT.ID_CLIENT");
      model->setHeaderData(0, Qt::Horizontal, QObject::tr("ID"));
     model->setHeaderData(1, Qt::Horizontal, QObject::tr("Nom"));
     model->setHeaderData(2, Qt::Horizontal, QObject::tr("Prenom"));
     model->setHeaderData(3, Qt::Horizontal, QObject::tr("adr_email"));
     model->setHeaderData(4, Qt::Horizontal, QObject::tr("desription"));
     model->setHeaderData(5, Qt::Horizontal, QObject::tr("nom_ev"));
 ...
 QSqlQueryModel* Client:: triid()
  ...
  {
     QSqlQueryModel * model = new QSqlQueryModel();
     model->setQuery("SELECT client_.id_client,client_.nom,client_.prenom,client_.adr_email,evenement.description,evenement.nom,evenement.date_ev FROM CLIENT_ INNER JOIN EVENEMENT ON CLIENT_.ID_CLIENT=EVENEMENT.ID_CLIENT WHERE  CLIENT_.ID_CLIENT  LIKE '%"+b+"%'");
