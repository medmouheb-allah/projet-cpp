...
Client::Client(QString y,QString z,QString t,QString w)
{
...
bool Client::ajouter()
{
   ...
   QString res=QString::number(id_client);
        query.prepare("INSERT INTO CLIENT_ (NOM, PRENOM, ADR_EMAIL, PHONE)" "values (:forname, :surname, :toname, :monname)");
